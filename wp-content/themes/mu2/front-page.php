...
<div class="row home-headlines">
    <div class="col-xs-6 col-sm-3">
        <a href="/blog"><p class="head">Health, Fitness & Nutrition</p></a>
        <div class="content">
    ...
    <div class="col-xs-6 col-sm-3">
        <a href="/events"><p class="head">Next Event Location</p></a>
        <div class="content">
            <p class="headsub">Come check us out.</p>
            <?php echo do_shortcode('[tt_posts limit="1" type="tribe_events" order="ASC" layout="list-event"]'); ?>
        </div>
    </div>
    <div class="col-xs-6 col-sm-3">
